...
[RED TEAM Operator: Malware Development Advanced - Vol.1](https://institute.sektor7.net/rto-maldev-adv1)
[RED TEAM Operator: Windows Evasion Course](https://institute.sektor7.net/rto-win-evasion)
[RED TEAM Operator: Windows Persistence Course](https://institute.sektor7.net/rto-windows-persistence)
[RED TEAM Operator: Privilege Escalation in Windows Course](https://institute.sektor7.net/rto-lpe-windows)

### mr.un1k0d3r
[Coding Class](https://mr.un1k0d3r.world/portal/)

### binary-offensive.
[Modern Initial Access and Evasion Tactics](https://www.binary-offensive.com/initial-access-training)

### cyberwarfare
[CredOps Infiltrator](https://cyberwarfare.live/product/certified-red-team-credops-infiltrator-crt-coi/)
